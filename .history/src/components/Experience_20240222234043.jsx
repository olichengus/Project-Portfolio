        ...
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center items-left w-full h-full'>
            ...
            <div className='mt-9 max-w-[1000px] w-full flex-col grid md:grid-cols-2 gap-4'>
                ...
                <div className=''>
                    ...
                    <p className='text-md mt-4 text-gray-300 w-full h-full object-cover font-sans'>Involved in Python scripting to test Arlo Smart Home Security products as well as maintaining device firmware deployment pipeline. Worked closely alongside Firmware, Software, and Product teams to discuss and fix bugs for new products and releases. Contributed to the successful launch of the Arlo Security Hub and its surrounding ecosystem such as Sensors, Sirens and Keypad.</p>
                </div>
            </div>
        </div>
        </div>
