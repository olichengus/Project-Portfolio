        ...
        <div name='about' className='w-full h-screen bg-gradient-to-r from-gray-900 via-blue-700 to-blue-400 text-gray-300'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div className='mt-9 max-w-[1000px] w-full grid grid-cols-2 gap-8'>
                    ...
                    <div>
                        I am passionate about learning every day and continuously improving my skills and knowledge. I am driven by my interest in Full-Stack Development, Firmware <Engineering></Engineering>
                    </div>
                </div>
            </div>
        </div>
