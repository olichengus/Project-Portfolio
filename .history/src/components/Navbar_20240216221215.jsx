    ...
    {/* menu */}
        <div className='hidden md:flex'>
            <ul className='hidden md:flex'>
                <li className='font-bold text-2xl hover:text-red-500'>Home</li>
                <li className='font-bold text-2xl hover:text-green-300'>About</li>
                <li className='font-bold text-2xl hover:text-purple-400'>Experience</li>
                <li className='font-bold text-2xl hover:text-blue-400'>Projects</li>
                <li className='font-bold text-2xl hover:text-orange-400'>Contact</li>
        ...
        <ul className={!nav ? "hidden": 'absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify center items-center'}>
                <li className='py-6 text-4xl'><a href="#" class="relative text-xl w-fit block after:block after:content-[''] after:absolute after:h-[3px] after:bg-black after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center">
Link
</a></li>
