  ...
  return (
    <div id='exp' className='bkgroundpage'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center items-left w-full h-full'>
            ...
            <div className='mt-9 max-w-[1000px] w-full grid md:grid-cols-2'>
                <div className='sm:text-right text-4xl font-bol grid md:grid-cols-2 gap-8'>
                    <img className="" src={Arlo}/>
                    <img className="" src={ArloFamily}/>
                    <img className="" src={Maple}/>
                </div>
                <div className=''>
