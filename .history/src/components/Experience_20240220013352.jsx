        ...
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center items-left w-full h-full'>
            ...
            <div className='mt-9 max-w-[1000px] w-full flex flex-col grid md:grid-cols-2 gap-4'>
                <div className='sm:text-right text-4xl font-bol grid md:grid-cols-2 gap-1 items-center'>
                    <div className='group container object-cover w-full h-full rounded-md flex justify-center items-center mx-autoh-150'>
                        <img className="flex-1 object-cover" src={Arlo}/>
                    </div>
                    <div className='flex'>
                        <img className="flex-1 object-cover" src={ArloFamily}/>
                    </div>
                    <div className='flex'>
                        <img className="flex-1 object-cover" src={Maple}/>
                    </div>
                    <div className='flex'>
