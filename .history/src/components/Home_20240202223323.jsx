  ...
  return (
    <div className='w-full h-screen bg-[#3b4ddb]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <h2 className='text-4xl sm:text-5xl font-bold text-[#8892b0]'> I'm a Computer Science Student @ UBC interested in Full-stack Development, Firmware Engineering, and Test Automation. </h2>
        <p> I'm a student that is interested in </p>
