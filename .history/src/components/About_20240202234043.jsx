            ...
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div className='mt-9 max-w-[1000px] w-full'>
                    <ul class="list-disc pl-4">
                        <li class="mb-2 text-3xl font-bold hover:text-white">My main technical interests are in Full Stack Development, Firmware Engineering, and Test Automation.</li>
