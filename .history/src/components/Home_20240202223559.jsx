    ...
    <div className='w-full h-screen bg-[#3b4ddb]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <div className='background-color'>
          <button className = 'text-white border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600'> My Projects <HiArrowNarrowRight className='ml-3' /></button>
        </div>
      </div>
