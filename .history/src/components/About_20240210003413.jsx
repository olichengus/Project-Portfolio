        ...
        <div name='about' className='w-full h-screen bg-gradient-to-r from-gray-900 via-blue-700 to-blue-400 text-gray-300'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div className='mt-9 max-w-[1000px] w-full grid grid-cols-2 gap-8'>
                    ...
                    <div>
                        I am a driven student striving to grow and learn everyday - not only as a developer, but also as a person. My main technical interests are with Full-Stack Development, Firmware Engineering, and Test Automation. In my free time, I love to watch and play sports. My main teams I cheer for are Manchester United and the Toronto Raptors.
                    </div>
                </div>
            </div>
        </div>
