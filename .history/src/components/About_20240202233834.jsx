            ...
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div className='mt-9 max-w-[1000px] w-full'>
                    <ul class="list-disc pl-4">
                        <li class="mb-2 text-3xl font-bold text-color hover:text-white">I am interested in Full Stack Development, Firmware Engineering, and Test Automation.</li>
                        <li class="mb-2 text-3xl font-bold hover:text-white">I am fluent in French and Mandarin</li>
                        <li class="mb-2 text-3xl font-bold hover:text-white">I am a massive Manchester United and Toronto Raptors Fan!</li>
                    </ul>
                </div>
            </div>
        </div>
