            ...
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div className='mt-9 max-w-[1000px] w-full grid grid-cols-2 gap-8'>
                    ...
                    <div>
                        ...
                        learning every day and continuously improving my skills and knowledge. I am driven by my interest in Full-Stack Development, Firmware Engineering, and Test Automation.
                    </div>
                </div>
            </div>
        </div>
